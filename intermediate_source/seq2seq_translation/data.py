...
def readLangs(lang1, lang2, reverse=False, data_dir='../data'):
    print("Reading lines...")

    # Read the file and split into lines
    lines = open('%s/%s-%s.txt' % (data_dir, lang1, lang2), encoding='utf-8').\
        read().strip().split('\n')
...
def indexesFromSentence2(lang, sentence):
    return [lang.word2index[word] if word in lang.word2index else UNK_token
